// ДЗ выполнено в нескольких вариантах: БЕЗ и С использование библиотеки Colors
// В первом случае необходим только файл index.js. 
// Для второго варианта необходимо дать команду npm i, раскомментировать строчки 5 и 40-42 или 44-54 на выбор.
